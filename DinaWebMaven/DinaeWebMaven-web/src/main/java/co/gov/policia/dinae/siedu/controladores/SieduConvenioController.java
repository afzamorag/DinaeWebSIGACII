...
import co.gov.policia.dinae.siedu.servicios.SieduConvenioService;
...
@Named
@SessionScoped
public class SieduConvenioController extends AbstractController {

  private static final Logger LOG = LoggerFactory.getLogger(SieduConvenioController.class);

  @EJB
  private SieduConvenioService service;
  private SieduConvenio selected;
  private List<SieduConvenio> list;
  private boolean editable;
  private NavEnum optionNavEnum;

  public SieduConvenioController() {
  ...
  public void onRowSelect(SelectEvent event) {
    ...
    setSelected((SieduConvenio) event.getObject());
    setEditable(false);
    optionNavEnum = NavEnum.DETAILS;
  }
  ...
  public void onSave() {
    ...
    try {
      if (getSelected().getConvConv() == null) {
  ...
  public boolean isNewRecord() {
    boolean newRecord = (getSelected() != null && getSelected().getConvConv() == null);
    return newRecord;
  }
   ...
   * @return the selected
   */
  public SieduConvenio getSelected() {
    return selected;
  }
   ...
   */
  public void setSelected(SieduConvenio selected) {
   ...
   * @return the list
   */
  public List<SieduConvenio> getList() {
    return list;
  }
   ...
   */
  public void setList(List<SieduConvenio> list) {
    this.list = list;
  }
