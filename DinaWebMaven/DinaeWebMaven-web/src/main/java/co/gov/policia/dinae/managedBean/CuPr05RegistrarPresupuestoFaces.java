 ...
 * @since 2013/11/19
 */
@javax.inject.Named(value = "registrarPresupuesto")
@javax.enterprise.context.SessionScoped
public class CuPr05RegistrarPresupuestoFaces extends JSFUtils implements Serializable {

    @javax.inject.Inject
    protected CuPr1ProyectoFaces proyectoFaces;

    @javax.inject.Inject
    protected CuPr7RegistrarAvanceInvestigacionFaces cuPr7RegistrarAvanceInvestigacionFaces;
    ...
    private enum ORIGEN_LLAMADO_CU {
        ...
        CU_PR_01, CU_PR_07, CU_PR_21
    };

    private String tituloProyecto = "Título de prueba";
    ...
    private ListGenericDataModel<FuenteProyectoDTO> _listaFuentesFinancierasModel;
    ...
    private List<LugarGeograficoDTO> _listaDepartamentoOrigenViaje;
    ...
    public static final String CU_PR_06 = "CU_PR_06";
    ...
    private Long _idTipoCompromiso;
    ...
    @Inject
    private CuPr05RegistrarPresupuestoImplementacionFaces _presupuestoImplFaces;
     ...
     */
    public void initProyectoCU21(Long idImplementacionProyecto, Long idCompromisoImplementacion, boolean permiteEditar) throws JpaDinaeException {

        _presupuestoImplFaces.initProyecto(idImplementacionProyecto, idCompromisoImplementacion, CU_PR_21, permiteEditar);
    }
     ...
     * @throws JpaDinaeException
     */
    public void initProyectoCU07(Long idProyecto, Long idCompromisoProyecto) throws JpaDinaeException {

        this._idTipoCompromiso = null;

        if (idProyecto != null && idCompromisoProyecto != null) {

            this._idCompromisoProyecto = idCompromisoProyecto;

            this._idTipoCompromiso = iCompromisoProyectoLocal.getIdTipoCompromisoProyectoPorCompromisoProyecto(idCompromisoProyecto);

            Proyecto proyectoSeleccionado = iProyecto.getProyectoByIdProyecto(idProyecto);

            initProyecto(proyectoSeleccionado.getIdProyecto(), CU_PR_7);
        }
    }
    ...
    private void inicializarFuenteProyecto(boolean esInterna) throws JpaDinaeException {
        ...
        _fuenteProyecto.setProyecto(_proyectoSeleccionado);
     ...
     * @param ingreso
     */
    public void initProyecto(Long idProyecto, String ingreso) {
        try {
            ...
            //SI EL LLAMADO ES DEL CU-PR-06, ENTONCES ES DE CONSULTA
            //NO SE VALIDA ROL
            _usuarioRol = null;
            if (!CU_PR_06.equals(_ingresoCU)) {

                RolUsuarioDTO rolUsuarioDTO;
                if (_proyectoSeleccionado.getCodigoProyecto() == null) {

                    //VIENE DE PROPUESTA DE CONVOCATORIA
                    rolUsuarioDTO = loginFaces.getPerfilUsuarioDTO().getRolUsuarioPorIdRolDTO(IConstantesRole.AUTORIZADO_PARA_REGISTRAR_PROPUESTAS_EN_CONVOCATORIAS_EN_LA_UNIDAD_POLICIAL);

                } else {

                    //VIENE DE PROYECTO
                    rolUsuarioDTO = loginFaces.getPerfilUsuarioDTO().getRolUsuarioPorIdRolDTO(IConstantesRole.RESPONSABLE_DE_PROYECTOS_DE_INVESTIGACION_EN_LA_UNIDAD_POLICIAL);
            ...
            String nombreUnidadPolicial = _proyectoSeleccionado.getUnidadPolicial().getSiglaFisica();
    ...
    private void cargarListadoFuentesProyecto() throws JpaDinaeException {
        ...
        _listaFuentesProyecto = iFuente.getListaFuentesPorProyectoDTO(_proyectoSeleccionado.getIdProyecto());
    ...
    public void cargarDatosFuenteProyecto(SelectEvent event) {
        try {
            ...
            if (_fuenteProyecto.getFuenteBase().equals('Y')) {

                adicionaMensajeError("Las fuentes básicas no pueden ser modificadas");
                inicializarFuenteProyecto(false);
    ...
    public BigDecimal calcularCostoInvestigadores(InvestigadorProyecto ip, int field) {
        ...
        if ((field == 0) && ip.getTipoVinculacion().getIdConstantes().equals(TIPO_INVESTIGADOR_PROYECTO_INVESTIGADOR_PRINCIPAL)) {
            valor = ip.getValorHora().multiply(BigDecimal.valueOf(ip.getHorasDedicacion()));
        }
    ...
    private void cargarListaEventosRelacionados() throws JpaDinaeException {
        _listaEventosProyectoDto = iEvento.getListaEventosPorProyectoDTO(_proyectoSeleccionado.getIdProyecto());
    ...
    private void nuevoEventoProyecto() {
        ...
        _eventoProyecto.setProyecto(_proyectoSeleccionado);
    ...
    private void validarCamposTabEventos() throws JpaDinaeException {
        ...
        if (_tituloEvento == null || "".equals(_tituloEvento)) {
            throw new JpaDinaeException("El campo '" + keyPropertiesFactory.value("cu_pr_5_lbl_titulo_evento") + "', es obligatorio");
        }

        if (_objetivoEvento == null || "".equals(_objetivoEvento)) {
            throw new JpaDinaeException("El campo '" + keyPropertiesFactory.value("cu_pr_5_lbl_objetivo_evento") + "', es obligatorio");
        }
        ...
        if (_ciudadEvento == null || _ciudadEvento.compareTo(-1L) == 0) {
            throw new JpaDinaeException("El campo '" + keyPropertiesFactory.value("cu_pr_5_lbl_ciudad_evento") + "', es obligatorio");
        }
    ...
    private void cargarViajesProyecto() throws JpaDinaeException {
        _listaViajesProyectoDto = iViajesProyecto.findViajesByProyectoDTO(_proyectoSeleccionado.getIdProyecto());
    ...
    private void cargarListaInvestigadoresViaje() throws JpaDinaeException {
        ...
        _listaInvestigadorViaje = iInvestigador.getListaInvestigadorProyectoPorProyecto(_proyectoSeleccionado.getIdProyecto());
    ...
    private void cargarListaDepartamentoOrigenViaje() throws JpaDinaeException {
        ...
        _listaDepartamentoOrigenViaje = iCiudad.getListaDepartamentos(10L);
        if (_listaDepartamentoOrigenViaje == null || _listaDepartamentoOrigenViaje.isEmpty()) {
            _listaDepartamentoOrigenViaje = new ArrayList<LugarGeograficoDTO>();
        }
    }
    ...
    private void cargarListaOtrosGastosProyecto() throws JpaDinaeException {
        _listaOtrosGastosProyectoDTO = iOtrosGastosProyecto.findOtrosGastosByProyectoDTO(_proyectoSeleccionado.getIdProyecto());
    ...
    private void validarCamposTabOtrosGastosProyecto() throws JpaDinaeException {
        ...
        OtrosGastosProyectoDTO conteoRubro = iOtrosGastosProyecto.contarOtrosGastosRubro(_proyectoSeleccionado.getIdProyecto(), _idTipoRubroOtrosGastos);
        int cont = 0;
    ...
    public void onTabChange(TabChangeEvent event) {
        try {
            ...
            if ("tabFuentesFinancieras".equals(event.getTab().getId())) {
                ...
                idTabSeleccionado = 6;
                presupuestoUtilFaces.construirPresupuesto(PresupuestoUtil.PRESUPUESTO_TIPO_VALUE_GLOBAL, _proyectoSeleccionado.getIdProyecto(), null);
    ...
    public String regresar() {
        ...
        try {
            ...
            if (CU_PR_1.equals(_ingresoCU)) {

                navegacion = navigationFaces.redirectCuPr1ProyectoFacesRedirect();

            } else if (CU_PR_7.equals(_ingresoCU)) {

                if (IConstantes.COMPROMISO_PERIODO_INFORME_FINAL.equals(_idTipoCompromiso)) {

                    navegacion = cuPr7RegistrarAvanceInvestigacionFaces.initReturnCU_Desde_CU_PR_10(_proyectoSeleccionado.getIdProyecto(), _idCompromisoProyecto);

                } else if (IConstantes.COMPROMISO_PERIODO_INFORME_DE_AVANCE.equals(_idTipoCompromiso)) {

                    navegacion = navigationFaces.redirectCuPr7RegistrarAvanceInvestigacionRedirect();

                }
            } else if (CU_PR_21.equals(_ingresoCU)) {

                navegacion = cuPr21RegistrarPlanDeTrabajoFaces.initReturnCU_DESDE_PR_20(_idImplementacionProyecto, _idCompromisoImplementacion, true);

            } else if (CU_PR_06.equals(_ingresoCU)) {

                navegacion = navigationFaces.redirectCuPr06ConsultarDetalleProyectoInvestigacion();
            }
    ...
    public List<LugarGeograficoDTO> getListaDepartamentoOrigenViaje() {
        return _listaDepartamentoOrigenViaje;
    }

    public void setListaDepartamentoOrigenViaje(List<LugarGeograficoDTO> _listaDepartamentoOrigenViaje) {
    ...
    public void setListaDepartamentoDestinoViaje(List<LugarGeograficoDTO> _listaDepartamentoDestinoViaje) {
        this._listaDepartamentoDestinoViaje = _listaDepartamentoDestinoViaje;
    }
    ...
    public boolean isSoloConsulta() {
        ...
        return CU_PR_06.equals(_ingresoCU);
