...
public class DominioJPAService implements DominioService {
  ...
  @Override
  public List<Dominio> findByFilter(Map<String, Object> params) throws ServiceException {
    LOG.trace("metodo: findByFilter() ->> parametros: params {}", params);
    List<Dominio> list;
    StringBuilder jpql = new StringBuilder();
    jpql.append("SELECT d FROM Dominio d WHERE 1 = 1 ");
    if (params != null) {
      if (params.get("descripcion") != null) {
        jpql.append("AND d.descripcionDominio = :descripcion ");
      }
      if (params.get("vigente") != null) {
        jpql.append("AND d.vigente = :vigente ");
      }
      if (params.get("tipo") != null) {
        jpql.append("AND d.idTipoDominio.idTipoDominio = :tipo ");
      }
    }
    jpql.append("ORDER BY d.descripcionDominio");
    try {
  ...
  @Override
  public Dominio findById(Long id) throws ServiceException {
    LOG.debug("metodo: findById() ->> parametros: id {}", id);
    try {
      Dominio i = (Dominio) sdo.find(em, id, Dominio.class);
      em.clear();
      return i;
    } catch (Exception ex) {
  ...
  @Override
  public Dominio create(Dominio record) throws ServiceException {
  ...
  @Override
  public void update(Dominio record) throws ServiceException {
  ...
  @Override
  public void delete(Dominio record) throws ServiceException {
  ...
  public void delete(Long id) throws ServiceException {
    ...
    try {
      sdo.remove(em, id, Dominio.class);
      em.flush();
    } catch (Exception ex) {
      LOG.error("metodo: delete() ->> mensaje: {}", ex.getMessage());
      throw new ServiceException(ex);
