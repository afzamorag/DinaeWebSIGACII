 ...
 */
@Stateless
public class SieduPropIntelectualEntidadJPAService implements SieduPropIntelectualEntidadService {

    private static final Logger LOG = LoggerFactory.getLogger(SieduPropIntelectualEntidadJPAService.class);
    ...
    @Override
    public List<SieduPropIntelectualEntidad> findAll() throws ServiceException {
        LOG.trace("metodo: findAll()");
        List<SieduPropIntelectualEntidad> list;
        try {
            list = sdo.getResultList(em, SieduPropIntelectualEntidad.class);
            em.clear();
        } catch (Exception ex) {
    ...
    @Override
    public List<SieduPropIntelectualEntidad> findByFilter(Map<String, Object> params) throws ServiceException {
        LOG.trace("metodo: findByFilter() ->> parametros: params {}", params);
        List<SieduPropIntelectualEntidad> list;
        StringBuilder jpql = new StringBuilder();
        jpql.append("SELECT d FROM SieduPropIntelectualEntidad d WHERE 1 = 1 ");
        if (params != null) {
    ...
    @Override
    public SieduPropIntelectualEntidad findById(SieduPropIntelectualEntidadPK id) throws ServiceException {
        LOG.debug("metodo: findById() ->> parametros: id {}", id);
        try {
            SieduPropIntelectualEntidad i = (SieduPropIntelectualEntidad) sdo.find(em, id, SieduPropIntelectualEntidad.class);
            em.clear();
            return i;
        } catch (Exception ex) {
    ...
    @Override
    public SieduPropIntelectualEntidad create(SieduPropIntelectualEntidad record) throws ServiceException {
    ...
    @Override
    public void update(SieduPropIntelectualEntidad record) throws ServiceException {
    ...
    @Override
    public void delete(SieduPropIntelectualEntidad record) throws ServiceException {
    ...
    @Override
    public void delete(SieduPropIntelectualEntidadPK id) throws ServiceException {
        LOG.debug("metodo: delete() ->> parametros: id {}", id);
        try {
            sdo.remove(em, id, SieduPropIntelectualEntidad.class);
            em.flush();
        } catch (Exception ex) {
            LOG.error("metodo: delete() ->> mensaje: {}", ex.getMessage());
            throw new ServiceException(ex);
    ...
    public void deleteByPropiedadId(Long propiedadId) throws ServiceException {
        ...
        try {
            Query query = em.createQuery(
                    "DELETE FROM SieduPropIntelectualEntidad c WHERE c.sieduPropIntelectualEntidadPK.idPin = :p");
